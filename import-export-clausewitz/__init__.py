...
def register():
    ...
    #bpy.utils.register_class(ClausewitzExporter)
    #bpy.utils.register_class(ClausewitzImporter)
...
def unregister():
    ...
    #bpy.utils.unregister_class(ClausewitzExporter)
    #bpy.utils.unregister_class(ClausewitzImporter)
